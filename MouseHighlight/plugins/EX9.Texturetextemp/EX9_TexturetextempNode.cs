...
{
	#region PluginInfo
	[PluginInfo(Name = "textemp", Category = "EX9.Texture", Help = "Basic template which creates a texture", Tags = "")]
	#endregion PluginInfo
	public class EX9_TexturetextempNode : IPluginEvaluate, IPartImportsSatisfiedNotification
	{
